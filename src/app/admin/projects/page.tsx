...
export default function ProjectsPage() {
  ...
  const { data, isLoading, error } = useQuery({
    queryKey: ["admin-projects", page, limit, filters, showReportedOnly, userId, userRole],
    queryFn: () =>
      showReportedOnly
        ? getReportedProjects({ page, limit, userId: filters.userId, search: filters.search }, apiClient.getHeaders())
        : getProjects({ page, limit, ...filters }, apiClient.getHeaders()),
              ...
              <tr key={project.id} className="hover:bg-gray-50">
                ...
                <td className="px-6 py-4 whitespace-nowrap">
                  <div className="flex flex-col gap-1">
                    ...
                    {!project.isHidden && !project.deletedAt && (
                        ...
                        {project.isHidden ? (
                          ...
                          <button
                            onClick={() => {
                              ...
                              if (reason) {
                                hideMutation.mutate({ projectId: project.id, hidden: true, reason });
                              }
                            }}
