...
import { useProjectReportMutation, ProjectReportReason } from "../mutations/useProjectReportMutation";
...
const REPORT_REASONS: { value: ProjectReportReason; label: string; description: string }[] = [
...
export default function ReportProjectModal({
  ...
  const [selectedReason, setSelectedReason] = useState<ProjectReportReason | null>(null);
  const [description, setDescription] = useState("");
  const reportMutation = useProjectReportMutation();
    ...
    <Modal
      ...
      title={
        <div className="flex items-center gap-2">
          ...
          <span>Report {targetType === "PROJECT" ? "Project" : "Comment"}</span>
        </div>
      }
      maxWidth="md"
